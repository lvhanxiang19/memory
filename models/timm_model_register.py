...
@register_model
def vit_tiny_mem_custom(pretrained=False, **kwargs): #5,543,716
    """ ViT-Tiny (Vit-Ti/16)
    """
    model_kwargs = dict(patch_size=16, embed_dim=192, depth=12, num_heads=3, **kwargs)
    model = _create_vision_transformermemory('vit_tiny_patch16_224', pretrained=pretrained, **model_kwargs)
...
def vit_tiny_new_custom(pretrained=False, **kwargs): #5,543,716
    ...
    """
    model_kwargs = dict(patch_size=16, embed_dim=192, depth=12, num_heads=3, **kwargs)
    model = _create_vision_transformer_new('vit_tiny_patch16_224', pretrained=pretrained, **model_kwargs)
    return model
@register_model
def vit_tiny_ultra_custom(pretrained=False, **kwargs): #5,543,716
    """ ViT-Tiny (Vit-Ti/16)
    """
    model_kwargs = dict(patch_size=16, embed_dim=192, depth=12, num_heads=3, **kwargs)
