...
class VisionTransformer_memory(nn.Module):
    """ Vision Transformer
    ...
    def __init__(
        ...
        if is_peer:
            ...
            block_fn(
                ...
                # memory args
                is_p=True,
                is_peer = True if i in mem_layer else False,
                mem_dim=mem_dim,
                mem_k_dim=mem_k_dim,
                mem_k_num=mem_k_num,
                mem_head=mem_head,
            ...
            block_fn(
                ...
                mlp_layer=mlp_layer,
                # memory args
                is_memory = True if i in mem_layer else False,
                mem_dim=mem_dim,
                mem_k_dim=mem_k_dim,
                mem_k_num=mem_k_num,
                mem_head=mem_head,
...
@torch.no_grad()
def _load_weights(model: VisionTransformer_memory, checkpoint_path: str, prefix: str = '') -> None:
...
def _convert_openai_clip(
        ...
        model: VisionTransformer_memory,
        prefix: str = 'visual.',
...
def _create_vision_transformermemory(variant: str, pretrained: bool = False, **kwargs) -> VisionTransformer_memory:
